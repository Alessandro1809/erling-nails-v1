...
import { c as createComponent, m as maybeRenderHead, b as renderComponent, e as renderScript, r as renderTemplate, d as addAttribute, f as clsx } from '../chunks/astro/server_C3IG_7V5.mjs';
import { b as $$Image, i as icon, j as jsxRuntimeExports, $ as $$Layout, a as $$Contact } from '../chunks/Contact_DpR6omOU.mjs';
/* empty css                                 */
...
const worldIconWhite = new Proxy({"src":"/_astro/WorldLogoWhite.BNaniiEv.svg","width":154,"height":152,"format":"svg"}, {
...
</p> ${renderComponent($$result, "swiper-container", "swiper-container", { "class": "mySwiper", "space-between": "30", "slides-per-view": "auto", "pagination": "true", "pagination-clickable": "true", "autoplay": "true", "autoplay-delay": "3000", "loop": "true", "data-astro-cid-j37ahk33": true }, { "default": () => renderTemplate` ${renderComponent($$result, "swiper-slide", "swiper-slide", { "class": "testimonial-slide flex flex-col overflow-hidden", "data-astro-cid-j37ahk33": true }, { "default": () => renderTemplate` <p data-astro-cid-j37ahk33>
...
</p> <span class="mt-4 font-light" data-astro-cid-j37ahk33>— Camila R.</span> ` })} ${renderComponent($$result, "swiper-slide", "swiper-slide", { "class": "testimonial-slide flex flex-col overflow-hidden", "data-astro-cid-j37ahk33": true }, { "default": () => renderTemplate` <p data-astro-cid-j37ahk33>
...
</p> <span class="mt-4 font-light" data-astro-cid-j37ahk33>— Valentina M.</span> ` })} ${renderComponent($$result, "swiper-slide", "swiper-slide", { "class": "testimonial-slide flex flex-col overflow-hidden", "data-astro-cid-j37ahk33": true }, { "default": () => renderTemplate` <p data-astro-cid-j37ahk33>
...
</p> <span class="mt-4 font-light" data-astro-cid-j37ahk33>— Andrea L.</span> ` })} ${renderComponent($$result, "swiper-slide", "swiper-slide", { "class": "testimonial-slide flex flex-col overflow-hidden", "data-astro-cid-j37ahk33": true }, { "default": () => renderTemplate` <p data-astro-cid-j37ahk33>
“Cada cita es una experiencia. Me relajo, me consiento y salgo feliz con
        mis uñas hermosas.”
</p> <span class="mt-4 font-light" data-astro-cid-j37ahk33>— Lucía T.</span> ` })} ${renderComponent($$result, "swiper-slide", "swiper-slide", { "class": "testimonial-slide flex flex-col overflow-hidden", "data-astro-cid-j37ahk33": true }, { "default": () => renderTemplate` <p data-astro-cid-j37ahk33>
“No solo es talentosa, también es súper amable. Se siente como visitar a
        una amiga.”
</p> <span class="mt-4 font-light" data-astro-cid-j37ahk33>— Belén T.</span> ` })} ` })} </section> ${renderScript($$result, "C:/Users/dales/Proyectos/dev/erling-nails-v1-main/src/components/Quotes.astro?astro&type=script&index=0&lang.ts")} `;
}, "C:/Users/dales/Proyectos/dev/erling-nails-v1-main/src/components/Quotes.astro", void 0);

const HeroVideo = "/_astro/HeroVideo.CLODuevp.webm";
...
const $$CallToAction = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="mb-20 md:mb-44 px-4 md:px-0"> <div class="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12"> <!-- Card de Agenda --> ${renderComponent($$result, "NeonGradientCard", NeonGradientCard, { "client:load": true, "className": "w-full max-w-sm items-center justify-center text-center animate-fade-in", "client:component-hydration": "load", "client:component-path": "@/components/NeonGradientCard", "client:component-export": "NeonGradientCard" }, { "default": ($$result2) => renderTemplate` <span class="pointer-events-none z-10 h-full whitespace-pre-wrap bg-gradient-to-br from-[#ff2975] from-35% to-[#7a00b3] bg-clip-text text-center text-4xl md:text-6xl font-bold leading-none tracking-tighter text-transparent dark:drop-shadow-[0_5px_5px_rgba(0,0,0,0.8)]">
Agenda Tu Cita!
</span> <a href="tel:+506876554321" class="button-red mt-6 md:mt-8 w-full md:w-auto animate-pulse-subtle">
Agendar
</a> ` })} <!-- Sección "Sobre mí" --> <div class="flex flex-col items-center text-center md:text-left animate-slide-up"> <h2 class="text-4xl md:text-6xl font-bold mb-6 md:mb-14 font-special tracking-wider">
...
const $$MobileFeatureGrid = createComponent(($$result, $$props, $$slots) => {
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main> ${renderComponent($$result2, "HeroSection", $$HeroSection, {})} <div class="hidden md:block"> ${renderComponent($$result2, "Bento", $$Bento, {})} </div> <div class="md:hidden"> ${renderComponent($$result2, "MobileFeatureGrid", $$MobileFeatureGrid, {})} </div> ${renderComponent($$result2, "Gallery", $$Gallery, {})} ${renderComponent($$result2, "Quotes", $$Quotes, {})} ${renderComponent($$result2, "CallToAction", $$CallToAction, {})} ${renderComponent($$result2, "Contact", $$Contact, {})} </main> ` })}`;
}, "C:/Users/dales/Proyectos/dev/erling-nails-v1-main/src/pages/index.astro", void 0);

const $$file = "C:/Users/dales/Proyectos/dev/erling-nails-v1-main/src/pages/index.astro";
const $$url = "";
